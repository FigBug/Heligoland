...
public:
    ...
    void update (float dt, Ship& myShip, const std::vector<const Ship*>& enemies, const std::vector<Shell>& shells, const std::vector<Island>& islands, float arenaWidth, float arenaHeight);
...
private:
    ...
    void updateMovement (float dt, const Ship& myShip, const std::vector<const Ship*>& enemies, const std::vector<Shell>& shells, const std::vector<Island>& islands, float arenaWidth, float arenaHeight);
